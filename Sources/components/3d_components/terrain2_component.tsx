...
export const TerrainModel2: React.FC<TerrainModelProps> = ({onClickTree, onClickChest,onClickSign, onClickBush, onClickRock  },props: Props, ) => {
    const { nodes, materials } = useGLTF(require('../../assets/3d/terrain2.glb')) as GLTFResult
